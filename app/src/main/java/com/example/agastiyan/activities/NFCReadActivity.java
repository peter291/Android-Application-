...
import com.example.agastiyan.scan.activities.ProductResultActivity;
...
public class NFCReadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mNfcAdapter.isEnabled()) {
            textView.setText("NFC Disabled");
        }
        else {
            textView.setText("NFC Enabled");
        }
    }
        ...
        protected void onPostExecute(String result) {
            ...
            if ((result != null) && (result.split("#").length == 3)){
                ...
                if(result.split("#")[1].equals(agaskey)) {
                    ...
                    Log.e(TAG, "Product response: " + "nfc");
                    // product details activity by passing barcode
                    Intent intent = new Intent(NFCReadActivity.this, ProductResultActivity.class);
                ...
                Toast.makeText(getApplicationContext(),
                        "Not a valid NFC card", Toast.LENGTH_LONG)
                        .show();
            }
            //new CheckAsynk().execute(result);
        }
    }
}
